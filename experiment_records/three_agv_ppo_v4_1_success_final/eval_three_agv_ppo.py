...
def main(env_cfg, agent_cfg):
    ...
    # Different skrl versions expose eval mode differently.
    # Current version may not have runner.set_running_mode().
    ...
    min_yaw_abs_inside_target = torch.full(
        (num_envs,),
        float("inf"),
        device=device,
    )
            ...
            with torch.inference_mode():
                ...
                for env_id in range(num_envs):
                    ...
                    traj_writer.writerow(
                        [
                            ...
                            int(base_env.current_waypoint_idx[env_id].item()),
                ...
                for env_id in range(num_envs):
                    ...
                    if hasattr(base_env, "last_success"):
                        ...
                        terminal_success = (
                                float(min_payload_target_dist[env_id].item()) < target_radius
